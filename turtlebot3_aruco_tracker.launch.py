...
def generate_launch_description():
    ...
    # static transform publisher node to tell the robot where camera is physically mounted on the robot's body

    camera_tf_node = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        # x y z yaw pitch roll parent child
        arguments=['0.01', '0.0', '0.10', '0', '0', '0', 'base_link', 'camera_rgb_frame'],
